...
var Presets = []PresetInfo{
	...
	{"charge-attack", "차지 공격", "전투", "charge up then release a powerful attack", 6, 12, false, "Charged attack: (1) hold a coiled charging pose for the first 2-3 frames, body trembling with gathered power, weapon drawn far back; (2) explosive release strike whipping through to full extension — the impact frame, weight slamming forward; (3) deep follow-through; (4) slow recovery. Big contrast: long still charge, then a very fast wide release."},
